...
def build_lobby_view(room: Room, viewer_id: int) -> dict[str, Any]:
    ...
    return {
        ...
        "game_length": room.game_length_mode,
        "target_score": room.game_length.target_score,
        "moon_points": room.game_length.moon_points,
        "alone_points": room.game_length.alone_points,
...
def build_state_view(
    ...
    return {
        ...
        "moon_points": session.moon_points,
        "alone_points": session.alone_points,
